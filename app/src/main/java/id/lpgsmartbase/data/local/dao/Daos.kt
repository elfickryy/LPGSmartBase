...
@Dao interface PelangganDao { @Query("SELECT * FROM pelanggan WHERE aktif = 1 ORDER BY nama") fun observeAll(): Flow<List<PelangganEntity>>; @Insert suspend fun insert(data: PelangganEntity): Long }
